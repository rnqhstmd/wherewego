...
| FR-GC1-7 | 그룹 채팅방 목록 API — 활성 그룹별 방 요약(미생성 그룹은 가상항목, `BotRoomSummary` AC-7 선례) + 멤버별 unread + 마지막 메시지 preview(REEL_LINK → "릴스 링크" 등 kind 별 규칙) | ✅ | [#118](https://github.com/rnqhstmd/wherewego/pull/118) |
