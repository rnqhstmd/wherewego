...
- **Phase 2.10 예정**: Pretendard 폰트 self-host 전환 (현재 CDN, `frontend/public/fonts/README.md`)
- **Phase 2.10 예정**: Mapbox 토큰 회전 SOP 운영자 가이드 (`.env.local.example`에 안내, 대시보드 URL Restriction 별도 작업)
