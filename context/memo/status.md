...
| FR-MMO-2 | 웹 UI 메모 수동 수정 (memo_source=MANUAL 저장) | ⬜ | Phase 2.6 |
...
| FR-MMO-4 | MANUAL이 AUTO를 덮어쓸 수 있는 권한 검사 (활성 GroupMember) | ⬜ | Phase 2.6 |

## 후속 작업

- **Phase 2.6**: FR-MMO-2/4 (웹 UI 메모 수정 + 활성 GroupMember 권한 검사)
